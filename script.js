  ...
  cards.forEach(card => {
    card.addEventListener("click", () => {
      ...
      if(type === "motion"){
        ...
        createSlider([
          {
            html:`<img class="popup-media active" src="img/news-app.png">`,
            title:"Nyheds-app",
          ...
          {
            html:`<img class="popup-media" src="img/studyplanner.png">`,
            title:"Studyplanner",
          ...
          {
            html:`<img class="popup-media" src="img/foodhub.png">`,
            title:"FoodHub",
        ...
        createSlider([
          {
            html:`<img class="popup-media active" src="img/toki.png">`,
            title:"Toki",
          ...
          {
            html:`<img class="popup-media" src="img/simgames.png">`,
          ...
          {
            html:`<img class="popup-media" src="img/berrichi.png">`,
            title:"Berrichi",
          ...
          {
            html:`<img class="popup-media" src="img/coffee.png">`,
            title:"Fika Roasters",
        ...
        createSlider([     
          {
            html:`<img class="popup-media" src="img/meta-some.png">`,
            title:"Meta-annoncer",
          ...
          {
            html:`<img class="popup-media" src="img/mucki-some.png">`,
            title:"Mucki Content",
          ...
          {
            html:`<img class="popup-media" src="img/simgames-some.png">`,
          ...
          {
            html:`<img class="popup-media active" src="img/fika.some.png">`,
